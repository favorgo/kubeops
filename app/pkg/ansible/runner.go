...
func (a *AdhocRunner) Run(ch chan []byte, result *types.Result) {
...
func (p *PlaybookRunner) Run(ch chan []byte, result *types.Result) {
	result.Success = false
...
func runCmd(ch chan []byte, projectName string, cmd *exec.Cmd, result *types.Result) {
